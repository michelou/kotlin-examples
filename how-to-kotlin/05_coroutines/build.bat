...
goto :args_loop
:args_done
if %_DEBUG%==1 echo %_DEBUG_LABEL% _CLEAN=%_CLEAN% _COMPILE=%_COMPILE% _MAIN_NAME=%_MAIN_NAME% _RUN=%_RUN% _VERBOSE=%_VERBOSE%
...
echo     run[:^<name^>]  execute the generated program ^(default: ThreadsVsCoroutines^)
goto :eof
