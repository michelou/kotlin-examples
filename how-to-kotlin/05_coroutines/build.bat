...
echo -language-version %_LANGUAGE_VERSION% -kotlin-home %KOTLIN_HOME% -cp "%_KOTLIN_CPATH:\=\\%" -d "%_CLASSES_DIR:\=\\%" > "%__OPTS_FILE%"
...
set __KOTLIN_OPTS=-cp "%_KOTLIN_CPATH%%_CLASSES_DIR%"
