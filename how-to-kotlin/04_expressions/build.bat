...
set _KOTLINC_NATIVE_OPTS=-language-version 1.4 -o "%_EXE_FILE%"
goto :eof
...
goto :args_loop
:args_done
if %_DEBUG%==1 echo %_DEBUG_LABEL% _CLEAN=%_CLEAN% _COMPILE=%_COMPILE% _DOC=%_DOC% _MAIN_NAME=%_MAIN_NAME% _RUN=%_RUN% _VERBOSE=%_VERBOSE%
...
:run_jvm
set __MAIN_CLASS=%_PKG_NAME%.%_MAIN_NAME%Kt
