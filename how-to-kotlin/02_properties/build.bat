...
@rem set _MAIN_NAME=Bean
@rem set _MAIN_CLASS=%_PKG_NAME%%_MAIN_NAME%Kt
@rem set "_EXE_FILE=%_TARGET_DIR%\%_MAIN_NAME%.exe"
...
echo     %__BEG_O%-jvm%__END%           generata JVM executable ^(default^)
