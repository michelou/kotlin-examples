...
@rem set __CENTRAL_REPO=https://repo1.maven.org/maven2
set __CENTRAL_REPO=https://repo.spring.io/plugins-release
...
call :add_jar "org.jetbrains.dokka" "dokka-gradle-plugin" "0.9.16"
