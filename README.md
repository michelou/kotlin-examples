...
C:\opt\detekt-cli-1.10.1\              <i>( 47 MB)</i>
...
1. [**`setenv.bat`**](setenv.bat) - This batch command makes external tools such as [**`gradle.bat`**][gradle_bat], [**`kotlinc.bat`**][kotlinc_bat] and [**`git.exe`**][git_exe] directly available from the command prompt (see section [**Project dependencies**](#proj_deps)).
   ...
   <b>&gt; setenv -verbose</b>
   Tool versions:
      gradle 6.5, java 1.8.0_252, detekt-cli 1.10.1,
      kotlinc 1.3.72, kotlinc-native 1.3.72, ktlint 0.37.1
   ...
   Tool paths:
      ...
      C:\opt\detekt-cli-1.10.1\bin\detekt-cli.bat
      ...
      C:\opt\ktlint-0.37.1\ktlint.bat
...
<li>we create an installation directory <b><code>c:\opt\ktlint-0.37.1\</code></b>.</li>
...
<b>&gt; mkdir c:\opt\ktlint-0.37.1</b>
<b>&gt; cd c:\opt\ktlint-0.37.1</b>
&nbsp;
<b>&gt; curl -sL -o ktlint.sh https://github.com/pinterest/ktlint/releases/download/0.37.1/ktlint</b>
...
<pre style="margin:0 0 1em 20px; font-size:80%;">
<b>&gt; dir /b c:\opt\ktlint-0.37.1</b>
ktlint.bat
&nbsp;
<b>&gt; c:\opt\ktlint-0.37.1\ktlint.bat --version</b>
0.37.1
</pre>
...
<a href="https://github.com/detekt/detekt/releases">detekt-cli-1.10.1.zip</a>                 <i>( 42 MB)</i>
...
[detekt_relnotes]: https://github.com/detekt/detekt/releases/tag/v1.10.0-RC1
...
[ktlint_relnotes]: https://github.com/pinterest/ktlint/releases/tag/0.37.1
