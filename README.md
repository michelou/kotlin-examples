...
1. [**`setenv.bat`**](setenv.bat) - This batch command makes external tools such as [**`gradle.bat`**][gradle_bat], [**`kotlinc.bat`**][kotlinc_bat] and [**`git.exe`**][git_exe] directly available from the command prompt (see section [**Project dependencies**](#proj_deps)).
   ...
   Tool versions:
      bazel 4.1.0, gradle 7.1, java 1.8.0_292, detekt-cli 1.17.1,
      kotlinc 1.5.10, kotlinc-native 1.5.10, ktlint 0.41.0
   ...
   Tool paths:
      ...
      C:\opt\kotlinc-1.5.10\bin\kotlinc.bat
      C:\opt\kotlin-native-windows-1.5.10\bin\kotlinc.bat
      C:\opt\kotlin-native-windows-1.5.10\bin\kotlinc-native.bat
   ...
   Environment variables:
      ...
      "KOTLIN_HOME=C:\opt\kotlinc-1.5.10"
      "KOTLIN_NATIVE_HOME=C:\opt\kotlinc-1.5.10"
...
[kotlin_relnotes]: https://github.com/JetBrains/kotlin/releases/tag/v1.5.10
