...
C:\opt\detekt-cli-1.17.0\             <i>( 49 MB)</i>
C:\opt\Git-2.31.1\                    <i>(279 MB)</i>
C:\opt\gradle-7.0\                    <i>(121 MB)</i>
C:\opt\kotlinc-1.5.0\                 <i>( 64 MB)</i>
C:\opt\kotlin-native-windows-1.5.0\   <i>(170 MB)</i>
...
1. [**`setenv.bat`**](setenv.bat) - This batch command makes external tools such as [**`gradle.bat`**][gradle_bat], [**`kotlinc.bat`**][kotlinc_bat] and [**`git.exe`**][git_exe] directly available from the command prompt (see section [**Project dependencies**](#proj_deps)).
   ...
   Tool versions:
      bazel 4.0.0, gradle 7.0, java 1.8.0_292, detekt-cli 1.17.0,
      kotlinc 1.5.0, kotlinc-native 1.5.0, ktlint 0.41.0
   ...
   Tool paths:
      ...
      C:\opt\c:\opt\jdk-openjdk-1.8.0u292-b10\bin\java.exe
      C:\opt\detekt-cli-1.17.0\bin\detekt-cli.bat
      C:\opt\kotlinc-1.5.0\bin\kotlinc.bat
      C:\opt\kotlin-native-windows-1.5.0\bin\kotlinc.bat
      C:\opt\kotlin-native-windows-1.5.0\bin\kotlinc-native.bat
   ...
   Environment variables:
      ...
      "DETEKT_HOME=C:\opt\detekt-cli-1.17.0"
      "JAVA_HOME=c:\opt\jdk-openjdk-1.8.0u292-b10"
      "KOTLIN_HOME=C:\opt\kotlinc-1.5.0"
      "KOTLIN_NATIVE_HOME=C:\opt\kotlinc-1.5.0"
...
<a href="https://github.com/detekt/detekt/releases">detekt-cli-1.17.0.zip</a>                     <i>( 44 MB)</i>
<a href="https://gradle.org/releases/">gradle-7.0-bin.zip</a>                        <i>(107 MB)</i>
<a href="https://github.com/JetBrains/kotlin/releases/tag/v1.5.0">kotlin-compiler-1.5.0.zip</a>                 <i>( 60 MB)</i>
<a href="https://github.com/JetBrains/kotlin/releases/tag/v1.5.0">kotlin-native-prebuilt-windows-1.5.0.zip</a>  <i>(125 MB)</i>
...
[detekt_relnotes]: https://github.com/detekt/detekt/releases/tag/v1.17.0
...
[kotlin_relnotes]: https://github.com/JetBrains/kotlin/releases/tag/v1.5.0
